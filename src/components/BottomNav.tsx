...
const TABS = [
  {
    ...
    label: 'Library',
    icon: (active: boolean) => (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={active ? '#C97D2E' : '#6B5744'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-navy border-t border-ink/10 safe-area-bottom">

...
export default function ReadingPage() {
  ...
  return (
    <main className="min-h-screen bg-navy text-white flex flex-col items-center justify-center px-6" style={{ paddingBottom: '5rem' }}>
      <div className="text-center max-w-sm">
        ...
        <p className="text-sm text-white/40 mb-6">Choose something from the library and your reading will resume here next time.</p>
